...
const SeedDetails = () => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      >
        <Image
          source={require("../../assets/images/410.jpg")}
      ...
      >
        <Text style={{ fontSize: ms(25), fontWeight: "600" }}>Okro</Text>
      </View>
      ...
      <View style={{ marginTop: ms(5) }}>
        <Text style={{ color: "#A9ABAD", fontSize: 16 }}>⭐ 4.9 (258)</Text>
      </View>
      ...
      {/* DESCRIPTION */}
        ...
        >
          Okra is a warm-season vegetable that thrives in hot climates. It
          requires full sun and well-drained soil to grow successfully. Okra
          plants are typically started from seeds, which should be sown directly
          into the garden after the last frost date. The seeds should be planted
          about 1 inch deep and spaced 12 to 18 inches apart in rows that are 3
          feet apart. 
        </Text>
      ...
      >
        <View style={{ flexDirection: "row", gap: ms(10) }}>
          ...
          />
          <Image
            source={require("../../assets/images/282.jpg")}
            style={{ width: s(80), height: ms(80), borderRadius: ms(10) }}
          />
          <Image
